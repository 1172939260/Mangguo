...
f=codecs.open('mangguo_url_new.txt','a','utf-8')
cookies={}
try:
...
for N in range(i,100):
    ...
    xiaoliangurl='https://s.taobao.com/search?data-key=s&data-value={}&ajax=true&_ksTS={}\
        &callback={}&q=芒果+水果+-芒果干&imgfile=&js=1&stats_click=search_radio_all%3A1\
        &initiative_id=staobaoz_20181221&ie=utf8&sort=sale-desc&bcoffset=0&p4ppushleft=%2C44&s={}'.format(data_value,_ksTS,callback,s)
    print(xiaoliangurl)
